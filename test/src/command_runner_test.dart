...
import 'package:simplehttpserver/src/command_runner.dart';
...
void main() {
  group('SimplehttpserverCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late SimplehttpserverCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = SimplehttpserverCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = SimplehttpserverCommandRunner();
